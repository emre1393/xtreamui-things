...
if (isset($_POST["submit_package"])) {
    ...
    foreach (Array("is_trial", "is_official", "can_gen_mag", "can_gen_e2", "only_mag", "only_e2", "lock_device", "is_restreamer", "is_isplock") as $rSelection) {
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        ...
                                                        <div class="form-group row mb-4">
                                                            ...
                                                            <div class="col-md-2">
                                                                <input name="is_isplock" id="is_isplock" type="checkbox" <?php if (isset($rPackage)) { if ($rPackage["is_isplock"] == 1) { echo "checked "; } } ?>data-plugin="switchery" class="js-switch" data-color="#039cfd"/>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row mb-4">
                                                        ...
                                                        <div class="form-group row mb-4">
                                                            ...
                                                            <div class="col-md-8">
                                                                <select name="forced_country" id="forced_country" class="form-control select2" data-toggle="select2">
                                                                    ...
                                                                    <option <?php if (isset($rPackage)) { if ($rPackage["forced_country"] == $rCountry["id"]) { echo "selected "; } } ?>value="<?=$rCountry["id"]?>"><?=$rCountry["name"]?></option>
                                                                    <?php } ?>
                                                                </select>
                                                            </div>
                                                        </div>
