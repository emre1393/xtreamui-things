...
if (isset($_GET["action"])) {
    if ($_GET["action"] == "stream") {
        ...
        // next 7 lines for reseller restart button permission.
        ...
        } else if (($rPermissions["is_admin"]) && (!hasPermissions("adv", "edit_stream"))) {
			echo json_encode(Array("result" => False));exit;
		}
        ...
        } else if (($rPermissions["is_admin"]) && ($rSub == "delete")) {
